...
class Stakeholder(models.Model):
    ...
    person = models.ForeignKey('base.User', related_name='person',verbose_name=u'拥有者',unique=True, on_delete = models.CASCADE)
...
class ResultCheck(models.Model):
    """结果查看"""
    user = models.ForeignKey('base.User',related_name='check_user',verbose_name=u'查看人',unique=True, on_delete = models.CASCADE)
