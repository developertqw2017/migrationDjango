...
class Assessment(models.Model):
    ...
    level_group = models.ForeignKey('AssessmentLevelGroup', verbose_name=u'评定级别组', null=True, blank=True, on_delete = models.CASCADE)
...
class AssessmentLine(models.Model):
    '''考核项'''
    level_group = models.ForeignKey('AssessmentLevelGroup', verbose_name=u'评定级别组', null=True, blank=True, on_delete = models.CASCADE)
    assessment = models.ForeignKey(Assessment,verbose_name=u'考核维度',null=False, on_delete = models.CASCADE)
...
class AssessmentLineDetail(models.Model):
    ...
    level_group = models.ForeignKey('AssessmentLevelGroup', verbose_name=u'评定级别组', null=True, blank=True, on_delete = models.CASCADE)
    level = models.ForeignKey('AssessmentLineLevel',verbose_name=u'评定级别', null=True, blank=True, on_delete = models.CASCADE)
...
class AssessmentLineLevel(models.Model):
    '''级别明细管理'''
    group = models.ForeignKey(AssessmentLevelGroup,verbose_name=u'级别组', on_delete = models.CASCADE)
