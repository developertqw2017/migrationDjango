...
class MonthPerformance(models.Model):
    ...
    department = models.ForeignKey('base.Department',related_name='month_department',verbose_name=u'部门', on_delete = models.CASCADE)
...
class MonthRecord(models.Model):
    ...
    month = models.ForeignKey('MonthPerformance',verbose_name=u'月份' , on_delete = models.CASCADE)
    date_time = models.DateTimeField(verbose_name=u'开始时间', null=True, )
    owner = models.ForeignKey('base.User', related_name='month_record_owner', verbose_name=u'得分人', null=False, on_delete = models.CASCADE)
...
class MonthScore(models.Model):
    '''月度考核结果'''
    month_record = models.ForeignKey(MonthRecord,verbose_name=u'考核月份',null=True,blank=True, on_delete = models.CASCADE)
    owner = models.ForeignKey('base.User',related_name='month_score_owner',verbose_name=u'得分人',null=True,blank=True, on_delete = models.CASCADE)
    assessment_line = models.ForeignKey(AssessmentLine, verbose_name=u'考核项', null=True,blank=True, on_delete = models.CASCADE)
...
class Record(models.Model):
    """打分记录"""
    month_record = models.ForeignKey(MonthRecord,verbose_name=u'月份', on_delete = models.CASCADE)
    assessment_line = models.ForeignKey(AssessmentLine,verbose_name=u'考核项',null=False, on_delete = models.CASCADE)
    ...
    owner = models.ForeignKey('base.User',related_name='record_owner',verbose_name=u'得分人',null=False, on_delete = models.CASCADE)
    mark = models.ForeignKey('base.User',related_name='record_mark',verbose_name=u'打分人',null=True,blank=True, on_delete = models.CASCADE)
