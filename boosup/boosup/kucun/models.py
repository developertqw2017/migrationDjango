...
class Goods(models.Model):
    ...
    add_people = models.ForeignKey('base.User', on_delete = models.CASCADE)
...
class Shop(models.Model):
    ...
    principal = models.ForeignKey('base.User', on_delete = models.CASCADE)  # 负责人
...
class GoodsShop(models.Model):
    ...
    last_updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
...
class GoodsRecord(models.Model):
    ...
    updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
...
class GoodsReturnRecord(models.Model):
    goods_sell_record = models.ForeignKey(GoodsSellRecord, on_delete = models.CASCADE)
    updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
    date = models.DateTimeField(auto_now_add=True)
...
class GoodsAddRecord(models.Model):
    ...
    inbound_channel = models.ForeignKey(InboundChannel, on_delete = models.CASCADE)
    remark = models.TextField(blank=True, null=True)
    updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
    date = models.DateTimeField(auto_now_add=True)
...
# from_shop = models.ForeignKey(Shop, related_name='from_shop', on_delete = models.CASCADE)
#     to_shop = models.ForeignKey(Shop, related_name='to_name', on_delete = models.CASCADE)
#     goods = models.ForeignKey(Goods, on_delete = models.CASCADE)
#     change_num = models.IntegerField()
#     updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
#     date = models.DateTimeField(auto_now_add=True)
...
class LineItem(models.Model):
    product = models.ForeignKey(GoodsShop, on_delete = models.CASCADE)
...
class TransferRecord(models.Model):
    transfer_shop = models.ForeignKey(TransferShop, on_delete = models.CASCADE)
    goods = models.ForeignKey(Goods, on_delete = models.CASCADE)
...
class RefundRecord(models.Model):
    sell_record = models.ForeignKey(GoodsSellRecord, on_delete = models.CASCADE)
    updater = models.ForeignKey('base.User', on_delete = models.CASCADE)
    date = models.DateTimeField(auto_now_add=True)
