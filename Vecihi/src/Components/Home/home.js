...
this._rowRenderer = this._rowRenderer.bind(this);
  ...
  async ratingCompleted(rating, post_id){
    ...
    try{
        ...
        //console.log("error -> " + e);
        Alert.alert("错误",'error: ' + e.message)
       // this.setState({loading: false})
    }
...
nav(){
  return(<View style={styles.nav1}>
    ...
    <View style={{width:340, alignItems:'center', justifyContent:"center", height:60, borderBottomWidth:10, borderBottomColor:'#333'}}>
        <Image source ={require('../../images/vecihi_logo.png')} resizeMode="stretch" style={{height:50, width:220}} />
    </View>
    ...
    <View style={styles.eachPost}>
      ...
      <View style={{}}>
        <View style={{flexDirection:'row', alignItems:'center'}}>
          ...
          <Text style={{fontSize:12, fontWeight:'600', color:'#333'}}>{x.upvoteCount} 医小聘</Text>
        </View>
